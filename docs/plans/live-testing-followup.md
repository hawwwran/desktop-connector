...
Closed so far: B8 (resume-after-kill — partly §12), B7 (large folder bind — partly §13), B3 (migration genesis-leg — partly §14), B5 (eviction — partly §15 partial PASS + partly §16 algorithm walk PASS). Wrong-passphrase rate-limit closed as partly §7 on 2026-05-12 (the protection is Argon2id-intrinsic; ADR at [`docs/architecture-decisions.md#2026-05-12`](../architecture-decisions.md)).

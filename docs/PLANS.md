...
| Plan | Intent | Status |
|------|--------|--------|
| [vault-open-items.md](plans/vault-open-items.md) | What's left before "v1" can be stamped on Vault. Evaluation gate at [`vault-critical-risks-evaluation.md`](vault-critical-risks-evaluation.md). §3.7 (rollback detection) closed 2026-05-15 via [`plans/live-testing-followup.md`](plans/live-testing-followup.md) §10. §11 (fresh-unlock UI enforcement, closes §3.9 + §3.11 caveats) is the remaining gate before v1 can be stamped. Architecture overview at [`vault-architecture.md`](vault-architecture.md). | Open |

...
_EVENT_TYPE_LABELS: dict[str, str] = {
    ...
    "vault.eviction.auto_purged_oldest":    "Eviction (auto-purged oldest)",
    "vault.eviction.alarm_purged_oldest":   "Eviction (alarm cleanup)",
    "vault.eviction.alarm_used_exceeds_quota": "Alarm — vault over quota",

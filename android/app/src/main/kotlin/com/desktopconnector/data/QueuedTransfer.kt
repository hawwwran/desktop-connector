...
enum class TransferStatus { QUEUED, UPLOADING, COMPLETE, FAILED }
...
interface TransferDao {
    ...
    @Query("SELECT * FROM queued_transfers WHERE status IN ('QUEUED', 'UPLOADING') AND direction = 'OUTGOING' ORDER BY createdAt ASC")
